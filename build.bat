...
cl ^
    ...
    src\geometry.cpp src\parse_obj.cpp src\bluenoise.cpp src\device.cpp src\bssrdf.cpp src\raytracing.cpp src\main.cpp ^
    ^
    out\lib.lib ^
    user32.lib ^
